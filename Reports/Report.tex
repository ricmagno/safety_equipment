...
\caption{\label{fig:orga29e1d8}Safety indicators (Source: Stats NZ from ACC claims and Ministry of Health hospitalisation)}
\end{figure}
...
\end{itemize}
\subsection{Duration:}
\label{sec:orgcc2e29a}
\begin{itemize}
\item Weeks: 11
\end{itemize}
\section{Project team}
\label{sec:orgd531a66}
\begin{enumerate}
