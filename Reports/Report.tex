...
\caption{\label{fig:org5e1f575}Safety indicators (Source: Stats NZ from ACC claims and Ministry of Health hospitalisation)}
\end{figure}
...
\end{itemize}
\subsection{Duration:}
\label{sec:org836b941}
\begin{itemize}
\item Weeks: 11
\end{itemize}
\section{Project team}
\label{sec:org7701713}
\begin{enumerate}
...
\label{sec:org5b52c87}
\subsubsection{Issue tracker set-up}
\label{sec:orgfe1ed04}
