...
\caption{\label{fig:org2bf956d}Safety indicators (Source: Stats NZ from ACC claims and Ministry of Health hospitalisation)}
\end{figure}
...
\end{itemize}
\subsection{Duration:}
\label{sec:org005b7fb}
\begin{itemize}
\item Weeks: 11
\end{itemize}
\section{Project team}
\label{sec:org6c14af8}
\begin{enumerate}
